# Write an OpenCV program that works like the automatic code on the PixyCam does, but runs on the webcam video feed.
# Given an image, and a predetermined range of hues to match, find blobs of the appropriate hues,
# and report their bounding rectangles by drawing them on the image. Run it on a video feed.
